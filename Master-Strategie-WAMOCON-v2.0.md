...
```mermaid
graph TB
    subgraph ORCHESTRATOR["🎛️ ORCHESTRATOR (7-Tage-Kadenz)"]
        ORC["Steuert Daily Content<br/>LinkedIn + Instagram + TikTok<br/>Cross-Posting-Koordination"]
    end

    subgraph RESEARCH["🔬 RESEARCH"]
        BOT1["🔍 Trend-Scout"]
        BOT2["📊 Audience-Analyst"]
    end

    subgraph CREATION["✍️ CREATION (5 Copywriter)"]
        BOT3["✏️ CW QA (K1)"]
        BOT4["🤖 CW KI (K2)"]
        BOT5["🎓 CW Academy (K3)"]
        BOT6["👥 CW People (K4)"]
    ...
    subgraph PRODUCTION["🎬 PRODUCTION"]
        BOT8["🖼️ Visual Designer"]
        BOT9["🎬 Video Scripter"]
        BOT13["📸 Instagram Specialist<br/>(NEU v2.0)"]
    end

    subgraph OPTIMIZATION["⚡ OPTIMIZATION"]
        BOT10["📝 Quality Gate"]
        BOT11["📅 Daily Scheduler"]
        BOT12["📈 Performance Analyst"]
    end

    ORC --> BOT1 & BOT2
    BOT1 & BOT2 --> BOT3 & BOT4 & BOT5 & BOT6 & BOT7
    BOT3 & BOT4 & BOT5 & BOT6 & BOT7 --> BOT8 & BOT9 & BOT13
    BOT8 & BOT9 & BOT13 --> BOT10
    BOT10 --> BOT11
    BOT11 --> BOT12
    BOT12 --> ORC
```
